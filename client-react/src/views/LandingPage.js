...
Geocode.setApiKey("AIzaSyD1oIAAQTQ4LntLXZsDdfj2kuF36ixzLAg");
Geocode.enableDebug();
    ...
    return (
      <>
        <div className="content">
          ...
          <AsyncMap
            googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyD1oIAAQTQ4LntLXZsDdfj2kuF36ixzLAg&libraries=places"
            loadingElement={<div style={{ height: `100%` }} />}
